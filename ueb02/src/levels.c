...
/* ---- Alle Level ---- */
// Level Vorlage
level lvEmpty = {{LV_BLACK, LV_BLACK, LV_BLACK, LV_BLACK, LV_BLACK, LV_BLACK,
                  LV_BLACK, LV_BLACK},
                 {LV_BLACK, LV_BLACK, LV_BLACK, LV_BLACK, LV_BLACK, LV_BLACK,
                  LV_BLACK, LV_BLACK},
                 {LV_BLACK, LV_BLACK, LV_BLACK, LV_BLACK, LV_BLACK, LV_BLACK,
                  LV_BLACK, LV_BLACK},
                 {LV_BLACK, LV_BLACK, LV_BLACK, LV_BLACK, LV_BLACK, LV_BLACK,
...
level lv1 = {
    ...
    {LV_WALL, LV_FREE, LV_SAND, LV_FREE, LV_WATER, LV_FREE, LV_WATER, LV_WALL},
    {LV_WALL, LV_SAND, LV_WALL, LV_WATER, LV_FREE, LV_SAND, LV_FREE, LV_WALL},
    {LV_WALL, LV_FREE, LV_SAND, LV_FREE, LV_WALL, LV_WALL, LV_FREE, LV_WALL},
    {LV_WALL, LV_FREE, LV_SAND, LV_FREE, LV_FREE, LV_FREE, LV_WALL, LV_WALL},
...
level lv3 = {
    ...
    {LV_BLACK, LV_BLACK, LV_BLACK, LV_BLACK, LV_WALL, LV_WALL, LV_WALL,
     LV_BLACK}};
...
level lv4 = {
    ...
    {LV_WALL, LV_FREE, LV_SUGAR, LV_SUGAR, LV_SUGAR, LV_SUGAR, LV_FREE,
     LV_WALL},
